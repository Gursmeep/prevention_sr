...
data<-read.csv("[DGHI] SR_prevention.csv",header=T)
...
tiff("/home/joao/Desktop/prevention_sr_network.tiff", width = 1500, height = 1000,compression = 'lzw')
network_meta <- qgraph(variable_data,layout = "spring",minimum=0.5,cut=3,labels=names,label.scale=FALSE,label.cex = label.cex,vsize=size_edges,color=color,shape=shape,posCol = "grey",borders = FALSE)
